...
class VideoProcessor():
    def __init__(self, vid_path, path_output):
        ...
        self.encoder = self.make_encoder(path_output)
    ...
    def make_encoder(self, path_output):
        ...
        # Check and make sure the output_video folder exists.
        #try:
        ...
        out_filename = f'{path_output}/{self.file_name}_video.mp4'
