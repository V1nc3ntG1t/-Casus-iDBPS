...
import transform_video_data.json_export as json
import transform_video_data.video_processor as vid_proc


class Generator:
    def __init__(self, vid_path, df, path_output):
        ...
        self.processor = vid_proc.VideoProcessor(vid_path, path_output)
    ...
    def make_json_file(self):
        out_filename = f"{self.path_output}/{self.processor.file_name}_video_data.json"
